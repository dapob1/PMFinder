...
tfidf_transformation.save("tfidf_200.model")
...
lsi_transformation = LsiModel(corpus=tfidf_transformation[bow_corpus], id2word=dictionary, num_topics=200)
lsi_transformation.save("lsi_200.model")
...
index = Similarity(corpus=lsi_transformation[tfidf_transformation[corpus]], num_features=200, output_prefix="shard")

# Save then load(to test) similarity index
index.save("similarity_index_200")
