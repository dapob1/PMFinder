...
# Open resume
with open("input_lipsum.txt", "rb") as inputFile:
...
tfidf_transformation = TfidfModel.load("tfidf_200.model")
...
lsi_transformation = LsiModel.load("lsi_200.model")
...
index = Similarity.load("similarity_index_200")
