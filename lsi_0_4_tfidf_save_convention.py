...
tfidf_transformation.save("tfidf.model")
...
lsi_transformation.save("singlemodel.lsi", separately=None, sep_limit=120000000)
lsi_transformation = LsiModel.load("singlemodel.lsi")
