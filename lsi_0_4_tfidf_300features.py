...
tfidf_transformation.save("tfidf_300.model")
...
lsi_transformation = LsiModel(corpus=tfidf_transformation[bow_corpus], id2word=dictionary, num_topics=300)
lsi_transformation.save("lsi_300.model")
lsi_transformation = LsiModel.load("lsi_300.model")
...
index = Similarity(corpus=lsi_transformation[tfidf_transformation[corpus]], num_features=300, output_prefix="shard")

# Save then load(to test) similarity index
index.save("similarity_index_300")
index = Similarity.load("similarity_index_300")
