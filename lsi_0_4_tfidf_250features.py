...
tfidf_transformation.save("tfidf_250.model")
...
lsi_transformation = LsiModel(corpus=tfidf_transformation[bow_corpus], id2word=dictionary, num_topics=250)
lsi_transformation.save("lsi_250.model")
lsi_transformation = LsiModel.load("lsi_250.model")
...
index = Similarity(corpus=lsi_transformation[tfidf_transformation[corpus]], num_features=250, output_prefix="shard")

# Save then load(to test) similarity index
index.save("similarity_index_250")
index = Similarity.load("similarity_index_250")
